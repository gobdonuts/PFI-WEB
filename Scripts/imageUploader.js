...
//
//  With the following:
//  <div class='imageUploader' id='0' controlId = 'PictureImageData' imageSrc='/Pictures/No_image.png' waitingImage="/PicturesManager/Pictures/Loading_icon.gif"> </div>
//  <span class="field-validation-valid text-danger" data-valmsg-for="PictureImageData" data-valmsg-replace="true"></span>
//
//
//  We obtain:
//  <div class="imageUploader" id="0" 
//       controlid="PictureImageData"
//       imagesrc="/Pictures/No_image.png" 
//       waitingImage = "/Reversi/Avatars/Loading_icon.gif" >
//
//      <!-- Image uploaded -->
//      <img id="PictureImageData_UploadedImage"
//           name="PictureImageData_UploadedImage"
//           class="UploadedImage"
//           src="/Avatars/no_avatar.png">
//
//      <!-- hidden file uploader -->
//      <input id="PictureImageData_ImageUploader"
//             type="file"
...
//             id="PictureImageData"
//             name="PictureImageData"
//             createmode="true"
//             waitingImage="/PicturesManager/Pictures/Loading_icon.gif">
//  </div>
//  <span class="field-validation-valid text-danger" data-valmsg-for="PictureImageData" data-valmsg-replace="true"></span>
//
/////////////////////////////////////////////////////////////////////////////////////////////////////////
...
function AddCustomValidator() {
    $.validator.addMethod("fileUploadedExistRule", function (value, element) { return CheckPicture(element); }, missingFileErrorMessage);
    $.validator.addMethod("fileUploadedSizeRule", function (value, element) { return CheckPictureSize(element); }, tooBigFileErrorMessage);
}

// Check if an image has been uploaded
function CheckPicture(element) {
...
function CheckPictureSize(element) {
